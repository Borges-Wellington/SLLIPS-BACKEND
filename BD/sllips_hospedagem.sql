...
CREATE TABLE `hospedagem` (
  `HospedagemID` int NOT NULL AUTO_INCREMENT,
  `NomeHospedagem` varchar(45) NOT NULL,
  PRIMARY KEY (`HospedagemID`)
...
INSERT INTO `hospedagem` VALUES (1,'Hotel'),(2,'Pousada'),(3,'Camping ');
