...
CREATE TABLE `registro` (
  ...
  `ViagemID` int DEFAULT NULL,
  `Avaliacao` int DEFAULT NULL,
  PRIMARY KEY (`RegistroID`),
  KEY `fk_estabelecimento` (`EstabelecimentoID`),
  KEY `fk_usuario_idx` (`UsuarioID`),
  CONSTRAINT `fk_estabelecimento` FOREIGN KEY (`EstabelecimentoID`) REFERENCES `estabelecimento` (`EstabelecimentoID`),
...
INSERT INTO `registro` VALUES (1,1,9,'2022-04-23 16:15:05',100.00,1,3),(2,1,9,'2022-04-23 16:18:45',16.50,1,4);
